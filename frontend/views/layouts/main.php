...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
            ...
            <div style="float: right; display: flex">
                <button class="navbar-toggler" style="border: none; background: none" type="button"
                ...
                <?php if (!Yii::$app->user->isGuest) { ?>
                    <div class="nav-item active dropdown small-screen-dropdown">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="form-inline my-2 my-lg-0" method="get"
                      action="<?= Html::encode(Url::toRoute('/site/index')) ?>">
        ...
        <?php if (!Yii::$app->user->isGuest) { ?>
            <div class="nav-item active dropdown big-screen-dropdown">
                <a class="nav-link" href="#" id="navbarDropdown" role="button"
                   data-toggle="dropdown"
                   aria-haspopup="true" aria-expanded="false" style="color: white">
                    <i class="fas fa-user-alt" style="font-size: 18px"></i>
